...
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
    ...
    print(Fore.LIGHTGREEN_EX+"{/} "+Style.RESET_ALL+"WickedGOD SMS Systems V1..."+Fore.LIGHTGREEN_EX+Style.BRIGHT+"WickedGOD \ Kötü Tanrı?\n"+Style.RESET_ALL)
    try:
        menu = int(input(Fore.LIGHTMAGENTA_EX + " 1- System Power ON\n 2- Systems Shut Down\n\n" + Fore.LIGHTYELLOW_EX + " Selection: "))
    except ValueError:
        system("cls||clear")
    ...
    if menu == 1:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Kaç Saniye Aralıkla Bir Mesaj Gitmesini İstersiniz? (0 Yazarak Sonsuz SMS Gönerebilirsiniz.) "+ Fore.LIGHTGREEN_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Çıkış Yapılıyor. (By WickedGOD)")
        break
